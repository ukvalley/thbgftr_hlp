...
class SettingController  extends Controller
{
    ...
    public function bank_details()
    {
      ...
      $this->arr_view_data['customer_panel_slug'] = $this->customer_panel_slug;
    	return view('customer.setting.bank_details',$this->arr_view_data);
    }
    ...
    public function change_password()
    {
      ...
      return view('customer.setting.change_password',$this->arr_view_data);
    }
    ...
    public function process_change_pass(Request $request)
    {
      ...
      if ($validator->fails()) 
      {
          return redirect(config('app.project.customer_panel_slug').'/change_password')
    ...
    public function store_bank_details(Request $request)
    {
     ...
     /* 'atm_card_no'      => 'required',
      ...
      if ($validator->fails()) 
      {
          return redirect(config('app.project.customer_panel_slug').'/bank_details')
                      ->withErrors($validator)
                      ->withInput($request->all());
      }
      ...
      return redirect('customer/bank_details_otp');
    }
    ...
    public function bank_details_otp()
    {
      ...
      return view('customer.setting.bank_details_otp',$this->arr_view_data);
    }
    ...
    public function activate_bank_details(Request $request)
    {
      ...
      if ($validator->fails()) 
      {
          return redirect(config('app.project.customer_panel_slug').'/bank_details_otp')
                      ->withErrors($validator)
                      ->withInput($request->all());
      }
      ...
      return redirect('customer/bank_details');
    }
