...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form" method="post" action="{{url('/')}}/customer/forget_password_process" data-parsley-validate="">
        {{ csrf_field() }}
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="username" name="username" type="text" maxlength="30" data-parsley-required="true">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="mobile" name="mobile" type="text" maxlength="10" data-parsley-required="true" data-parsley-pattern="[1-9]{1}[0-9]{9}" data-parsley-pattern-message="Please enter valid mobile no.">
        ...
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
              <p class="mdi-hardware-keyboard-backspace"><a href="{{url('/')}}/admin">Back To Login</a></p>
          </div>          
        </div>
