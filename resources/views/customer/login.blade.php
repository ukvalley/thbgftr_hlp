...
<head>
  ...
  <title>Login Page | Life time help Organisation</title>
...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form" method="post" action="{{url('/')}}/customer/login_process" data-parsley-validate="">
        {{ csrf_field() }}
        ...
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text">Login Your Account</p>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input id="username" name="username" type="text" value="{{$_COOKIE['username'] or ''}}" data-parsley-required="true">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="password" name="password" type="password" value="{{$_COOKIE['password'] or ''}}" data-parsley-required="true">
        ...
        <div class="row">
          <div class="input-field col s12">
            <input type="submit" class="btn waves-effect waves-light col s12" id="submit" name="submit">
            
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small"><a href="{{url('/')}}/customer/registration">Register Now!</a></p>
          </div>
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="{{url('/')}}/customer/forget_password">Forgot password ?</a></p>
          </div>          
        </div>
