          ...
          <div class="content">
            <div class="row">
              <div id="site-layout-example-top" class="col s12">
                <h1 class="flat-text-logo center white-text caption-uppercase">This page is under Construction</h1>
              </div>
              <div id="site-layout-example-right" class="col s12 m12 l12">
                ...
                <div class="row center">
                  <p class="center white-text col s12">Some work is being happening on website so this page is under Construction</p>
                  <p class="center s12"><button onclick="goBack()" class="btn waves-effect waves-light">Back</button> <a href="{{url('/')}}/admin/dashboard" class="btn waves-effect waves-light">GO to Dashboard</a>
                    <p>
                    </p>
                </div>
              </div>
