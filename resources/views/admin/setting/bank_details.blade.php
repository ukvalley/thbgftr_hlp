              ...
              <div class="row">
                <div class="col s12 m12 8">
                  ...
                  <div class="card-panel">
                    ...
                    <div class="row">
                      <form class="col s12" method="post" action="{{url('/')}}/admin/store_bank_details" data-parsley-validate="">
                        {{ csrf_field() }}
                        <div class="row">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                          <div class="input-field col s12">
                            <input id="paytm_no" name="paytm_no" type="text" value="{{ (!empty($data[0]['paytm_no']))?base64_decode(base64_decode($data[0]['paytm_no'])):""}}">
                            <label for="paytm_no">Paytm No.</label>
                          </div>
                        </div>
                         <div class="row">
                          <div class="input-field col s12">
                            <input id="btc_address" name="btc_address" type="text" value="{{ (!empty($data[0]['btc_address']))?base64_decode(base64_decode($data[0]['btc_address'])):""}}">
