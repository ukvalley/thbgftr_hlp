              ...
              {{ csrf_field() }}
               @include('admin.layout._operation_status')
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Profile Edit-{{$data->user_name}}</strong></h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input id="user_name" name="user_name" type="text" readonly="" data-parsley-required="true" class="form-control"/>
                                                    </div> 
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="email" name="email" type="text" value="{{$data->email}}" readonly="" data-parsley-required="true" class="form-control"/>
                                                      </div>            
                                                    <span class="help-block">This is sample of text field</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input id="spencer_id" name="spencer_id" type="text" value="{{$data->spencer_id}}" data-parsley-required="true" readonly="" class="form-control"/>
                                                    </div>                                            
                                                    <span class="help-block">This is sample of text field</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                         <input id="mobile" name="mobile" type="text"  value="{{$data->mobile}}" class="form-control" data-parsley-required="true">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" id="submit" name="submit">
                                </div>
                            </div>
                            </form>
