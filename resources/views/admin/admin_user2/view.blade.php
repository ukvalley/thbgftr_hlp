              ...
              {{ csrf_field() }}
               @include('admin.layout._operation_status')
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>View-{{$data->user_name}}</strong></h3>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <b><a href="upi://pay?pa={{$data->bhim_upi}}&pn={{$data->user_name}}&am={{$_GET['amt']}}"><button type="button" class="btn bg-orange btn-flat margin">{{$data->bhim_upi}}<br> click here or pay on UPI</button></b></a>
                                                        @else
                                                <b>Not Available</b>
                                                @endif
                                                    </div>                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                       ...
                                                       <b><a href="paytmmp://cash_wallet?featuretype=sendmoneymobile&recipient={{$data->paytm}}&amount={{$_GET['amt']}}" ><button type="button" class="btn bg-navy btn-flat margin">{{$data->paytm}}<br> click here or pay on paytm</button></b></a>
                                                       @else
                                        <b>Not Available</b>
                                        @endif
                                             ...
                                             <div class="form-group">
                                                <label class="col-md-3">UPI Payment:</label>
                                                   @if($data->phonepe!=null && strlen($data->phonepe) >= 10)
                                                                                           
                                                    <div class="">
                                                       <b><a href="upi://pay?pa={{$data->phonepe}}@ybl&pn={{$data->user_name}}&am={{$_GET['amt']}}"><button type="button" class="btn bg-purple btn-flat margin">{{$data->phonepe}}<br> click here or pay on UPI</button></b></a>
                                                        @else
                                               <div><b>Not Available</b></div>
                                                @endif
                                                  <b><center><p style="color:red;"><b>Don't Use phonepe for below UPI Payment method</b><p></center></b>
