       ...
       Change Transaction Pin
        <small>Control panel</small>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           <form class="col s12" method="post" action="{{url('/')}}/admin/process_change_trans_password" data-parsley-validate="">
              {{ csrf_field() }}
               @include('admin.layout._operation_status')
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Old Pin</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input id="old_pass" name="old_pass" type="password" data-parsley-required="true"  class="form-control"/>
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Confirm Pin</label>
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                        <input id="cpassword" name="cpassword" type="password" style="width: 50%" data-parsley-equalto="#password" data-parsley-required="true" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input id="cpassword" name="cpassword" type="password"  data-parsley-equalto="#password" data-parsley-required="true"  class="form-control"/>
